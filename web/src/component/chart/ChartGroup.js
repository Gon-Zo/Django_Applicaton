...
export default () => {
    return (
        <div className="row tm-content-row app-wrap-margin">

            {/*<div className="app-style-red app-slide-wrap">*/}
            {/*    <ChartTest/>*/}
            {/*</div>*/}


            {/*<div>*/}
            {/*    <div className="app-card-sm col-sm-12 col-md-12 col-lg-6 col-xl-6 tm-block-col">*/}
